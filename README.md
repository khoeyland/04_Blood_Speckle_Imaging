...
When arriving at the BSI part of the protocol, I shift from prospective to retrospective acquisitions. I turn on RF data, and I deactivate Variance button. For each view, I record data first at the frame rate index 0, then intermediate step 1 (around 60 fps), then intermediate step 2 (often somewhere between ~80 and ~110 fps), and finally maximal position for frame rate button (often somewhere between 180 and 190 fps).
